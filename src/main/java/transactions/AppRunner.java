...
public class AppRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            logger.info("v--- The following exception is expected because null is not valid for the DB. ---v");
            logger.error(e.getMessage());
        }
        ...
        logger.info("You shouldn't see Buddy or null. null violated DB constraints and Buddy was rolled back in the same transaction.");
